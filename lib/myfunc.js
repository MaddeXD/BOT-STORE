...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === fox.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = fox.user.id.split(':')[0]+'@s.whatsapp.net'
}
